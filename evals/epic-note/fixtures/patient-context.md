# Patient Context (Synthetic Test Data)

This is synthetic test data for evaluating the `epic-note` skill. No real PHI.
...
- Essential hypertension (recently treated)
