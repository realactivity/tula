...
- **Mental health crisis**: active suicidal ideation, plan, or intent;
  self-harm in progress.
- **Bleeding / trauma**: heavy bleeding that won't stop after 10 minutes of
  pressure, severe head injury, sudden vision loss.
- **Abdominal**: new severe abdominal pain, especially with vomiting blood,
  rigid abdomen, or fever.
- **Sepsis risk**: fever with chills, confusion, or hypotension in an
  immunocompromised, post-surgical, or oncology patient.
- **Pregnancy**: heavy vaginal bleeding, severe pelvic pain, decreased fetal
  movement in third trimester.
- **Pediatric (caregiver)**: lethargy, poor responsiveness, breathing
  difficulty, or persistent high fever in an infant.

## Required redirect text

When red flags are present, return:
...
Do not append a drafted message after the redirect.
